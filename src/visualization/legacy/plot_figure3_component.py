"""Generate Figure 2: Component Necessity Analysis (ABIDE real-data).

Validates each BS-NET pipeline component's contribution via leave-one-out
analysis on ABIDE N=468 subjects, 10 seeds.

Design:
  Panel A: Range bar (mean±SD) + scatter of ρ̂T per condition (6 conditions)
  Panel B: Range bar (mean±SD) + scatter of Δρ̂T from full pipeline (5 ablated)
  Style: Floating bars with subsampled scatter dots, red diamond mean marker
